...
import ModalCreateAndUpdateUser from '../../../components/Modal/ModalCreateAndUpdateUser';
...
export default function BasicTable() {
    ...
    useEffect(() => {
        async function loadAllUser(page) {
            try {
                const loadData = await axios.get(`http://localhost:3500/user?page=${page}`);
                if (loadData.error) {
                        ...
                        {data && data.map((value, index) => {
                            return (
                                ...
                                >
                                    ...
                                    <TableCell align="right">{value.gender = true ? "Nam" : "Nữ"}</TableCell>
